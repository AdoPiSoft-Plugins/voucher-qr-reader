...
var Html5Qrcode = function() {
  function e(t, n) {
    if (_classCallCheck(this, e), !qrcode) throw "qrcode is not defined, use the minified/html5-qrcode.min.js for proper support";
    this._elementId = t, this._foreverScanTimeout = null, this._localMediaStream = null, this._shouldScan = !0, this._url = window.URL || window.webkitURL || window.mozURL || window.msURL, this._userMedia = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia, this._isScanning = !1, e.VERBOSE = !0 === n
  }
  return _createClass(e, [{
    key: "start",
    value: function(t, n, i, a) {
      var r = this;
      if (!t) throw "cameraId is required";
      if (!i || "function" != typeof i) throw "qrCodeSuccessCallback is required and should be a function.";
      a || (a = console.log), this._clearElement();
      var o = this,
        c = n || {};
      c.fps = c.fps ? c.fps : e.SCAN_DEFAULT_FPS;
      var s = null != c.qrbox,
        l = document.getElementById(this._elementId),
        d = l.clientWidth ? l.clientWidth : e.DEFAULT_WIDTH;
      if (l.style.position = "relative", this._shouldScan = !0, this._element = l, qrcode.callback = i, s) {
        var h = c.qrbox;
        if (h < e.MIN_QR_BOX_SIZE) throw "minimum size of 'config.qrbox' is ".concat(e.MIN_QR_BOX_SIZE, "px.");
        if (h > d) throw "'config.qrbox' should not be greater than the width of the HTML element."
      }
      var u = function(t) {
        return new Promise(function(n, i) {
          var h;
          o._localMediaStream = t, h = r._createVideoElement(d), o._element.append(h), h.onabort = i, h.onerror = i, h.onplaying = function() {
            ! function(e, t) {
              var n = c.qrbox;
              n > t && console.warn("[Html5Qrcode] config.qrboxsize is greater than video height. Shading will be ignored");
              var i = s && n <= t,
                a = {
                  x: 0,
                  y: 0,
                ...
                d = i ? r._getShadedRegionBounds(e, t, n) : a,
                h = r._createCanvasElement(d.width, d.height),
                u = h.getContext("2d");
              u.canvas.width = d.width, u.canvas.height = d.height, l.append(h), i && r._possiblyInsertShadingElement(l, t, d), o._qrRegion = d, o._context = u, o._canvasElement = h
              ...
              if (o._shouldScan) {
                if (o._localMediaStream) {
                  var n = o._videoElement,
                    ...
                    s = n.videoHeight / n.clientHeight,
                    l = o._qrRegion.width * i,
                    d = o._qrRegion.height * s;
                  o._context.drawImage(o._videoElement, o._qrRegion.x, o._qrRegion.y, l, d, 0, 0, o._qrRegion.width, o._qrRegion.height);
                  try {
                    qrcode.decode(), r._possiblyUpdateShaders(!0)
                  } catch (e) {
                    r._possiblyUpdateShaders(!1), a("QR code parse error, error = ".concat(e))
                  }
                }
                o._foreverScanTimeout = setTimeout(t, e._getTimeoutFps(c.fps))
              }
            }(), n()
          }, h.srcObject = t, h.play(), o._videoElement = h
        })
      };
      return new Promise(function(e, n) {
        if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
          ...
          navigator.getUserMedia(a, function(t) {
            u(t).then(function(t) {
              o._isScanning = !0, e()
            }).catch(n)
          }, function(e) {
    ...
    value: function() {
      ...
      return new Promise(function(n, i) {
        ...
        var a = t._localMediaStream.getVideoTracks().length,
          r = 0,
          o = function() {
            t._localMediaStream = null, t._element.removeChild(t._videoElement), t._element.removeChild(t._canvasElement),
              function() {
                for (; t._element.getElementsByClassName(e.SHADED_REGION_CLASSNAME).length;) {
                  var n = t._element.getElementsByClassName(e.SHADED_REGION_CLASSNAME)[0];
                  t._element.removeChild(n)
                }
              }(), t._isScanning = !1, t._qrRegion && (t._qrRegion = null), t._context && (t._context = null), n(!0)
          };
    ...
    value: function(t, n) {
      ...
      if (n = void 0 === n || n, i._isScanning) throw "Close ongoing scan before scanning a file.";
      return new Promise(function(a, r) {
        i._possiblyCloseLastScanImageFile(), i._clearElement(), i._lastScanImageFile = t;
        var o = new Image;
        o.onload = function() {
          var t = o.width,
            c = o.height,
            s = document.getElementById(i._elementId),
            l = s.clientWidth ? s.clientWidth : e.DEFAULT_WIDTH,
            d = s.clientHeight ? s.clientHeight : c,
            h = function t(n, i, a, r) {
              if (n <= a && i <= r) return {
                x: (a - n) / 2,
                y: (r - i) / 2,
                width: n,
              ...
              var o = n,
                c = i;
              return n > a && (i *= a / n, n = a), i > r && (n *= r / i, i = r), e._log("Image downsampled from ".concat(o, "X").concat(c) + " to ".concat(n, "X").concat(i, ".")), t(n, i, a, r)
            }(t, c, l, d);
          if (n) {
            var u = i._createCanvasElement(l, d, "qr-canvas-visible");
            u.style.display = "inline-block", s.appendChild(u);
            var _ = u.getContext("2d");
            _.canvas.width = l, _.canvas.height = d, _.drawImage(o, 0, 0, t, c, h.x, h.y, h.width, h.height)
          }
          var g = i._createCanvasElement(h.width, h.height);
          s.appendChild(g);
          var f = g.getContext("2d");
          f.canvas.width = h.width, f.canvas.height = h.height, f.drawImage(o, 0, 0, t, c, 0, 0, h.width, h.height);
          try {
            a(qrcode.decode())
          } catch (e) {
            r("QR code parse error, error = ".concat(e))
          }
        }, o.onerror = r, o.onabort = r, o.onstalled = r, o.onsuspend = r, o.src = URL.createObjectURL(t)
      })
    }
  }, {
    key: "clear",
    ...
    value: function(e, t, n) {
      ...
      return r.style.width = "".concat(i, "px"), r.style.height = "".concat(a, "px"), r.style.display = "none", r.id = null == n ? "qr-canvas" : n, r
    }
  }, {
    key: "_createVideoElement",
    value: function(e) {
      var t = document.createElement("video");
      return t.style.width = "".concat(e, "px"), t.muted = !0, t.playsInline = !0, t
    }
  }, {
    ...
    value: function(t, n, i) {
      ...
      if (0 != i.x || 0 != i.y) {
        var r = {};
        r[e.SHADED_LEFT] = this._createShadedElement(n, i, e.SHADED_LEFT), r[e.SHADED_RIGHT] = this._createShadedElement(n, i, e.SHADED_RIGHT), r[e.SHADED_TOP] = this._createShadedElement(n, i, e.SHADED_TOP), r[e.SHADED_BOTTOM] = this._createShadedElement(n, i, e.SHADED_BOTTOM), Object.keys(r).forEach(function(e) {
          return t.append(r[e])
        }), i.x < 10 || i.y < 10 ? this.hasBorderShaders = !1 : (Object.keys(r).forEach(function(e) {
          return a._insertShaderBorders(r[e], i, e)
    ...
    value: function(t, n, i) {
      ...
      switch (a.style.position = "absolute", a.style.height = "".concat(t, "px"), a.className = e.SHADED_REGION_CLASSNAME, a.id = "".concat(e.SHADED_REGION_CLASSNAME, "_").concat(i), a.style.background = "#0000007a", i) {
        case e.SHADED_LEFT:
          a.style.top = "0px", a.style.left = "0px", a.style.width = "".concat(n.x, "px"), a.style.height = "".concat(t, "px");
          break;
        case e.SHADED_RIGHT:
          a.style.top = "0px", a.style.right = "0px", a.style.width = "".concat(n.x, "px"), a.style.height = "".concat(t, "px");
          break;
        case e.SHADED_TOP:
          a.style.top = "0px", a.style.left = "".concat(n.x, "px"), a.style.width = "".concat(n.width, "px"), a.style.height = "".concat(n.y, "px");
          break;
        case e.SHADED_BOTTOM:
          var r = n.y + n.height;
          a.style.top = "".concat(r, "px"), a.style.left = "".concat(n.x, "px"), a.style.width = "".concat(n.width, "px"), a.style.height = "".concat(n.y, "px");
          break;
        default:
    ...
    value: function(t, n, i) {
      ...
      var a = this,
        r = function(n, r) {
          if (null === n || null === r) throw "Shaders should have defined positions";
          var o = function() {
            var t = document.createElement("div");
            switch (t.style.position = "absolute", t.style.backgroundColor = e.BORDER_SHADER_DEFAULT_COLOR, i) {
              case e.SHADED_LEFT:
              case e.SHADED_RIGHT:
                t.style.width = "".concat(5, "px"), t.style.height = "".concat(45, "px");
                break;
              case e.SHADED_TOP:
              case e.SHADED_BOTTOM:
                t.style.width = "".concat(45, "px"), t.style.height = "".concat(5, "px");
                break;
              default:
                throw "Unsupported shadingPosition"
            }
          ...
          o.style.top = "".concat(n, "px"), o.style.left = "".concat(r, "px"), t.appendChild(o), a.borderShaders || (a.borderShaders = []), a.borderShaders.push(o)
        },
        o = null,
        c = null,
        s = null,
      ...
      switch (i) {
        case e.SHADED_LEFT:
          o = n.y - 5, c = n.x - 5, s = n.y + n.height - 40, l = c;
          break;
        case e.SHADED_RIGHT:
          o = n.y - 5, c = 0, s = n.y + n.height - 40, l = c;
          break;
        case e.SHADED_TOP:
          c = -5, s = o = n.y - 5, l = n.width - 40;
          break;
        case e.SHADED_BOTTOM:
          c = -5, s = o = 0, l = n.width - 40;
          break;
        default:
          throw "Unsupported shadingPosition"
      }
    ...
    value: function(t) {
      this.qrMatch !== t && (this.hasBorderShaders && this.borderShaders && this.borderShaders.length && this.borderShaders.forEach(function(n) {
        n.style.backgroundColor = t ? e.BORDER_SHADER_MATCH_COLOR : e.BORDER_SHADER_DEFAULT_COLOR
      }), this.qrMatch = t)
    }
  }, {
    ...
    value: function() {
      ...
      return new Promise(function(t, n) {
        if (navigator.mediaDevices && navigator.mediaDevices.enumerateDevices && navigator.mediaDevices.getUserMedia) e._log("navigator.mediaDevices used"), navigator.mediaDevices.getUserMedia({
          audio: !1,
          video: !0
        }).then(function(i) {
          i.oninactive = function(t) {
            return e._log("All streams closed")
          };
          navigator.mediaDevices.enumerateDevices().then(function(n) {
            for (var a = [], r = 0; r < n.length; r++) {
              var o = n[r];
              "videoinput" == o.kind && a.push({
                id: o.deviceId,
                label: o.label
              })
            }
            e._log("".concat(a.length, " results found")),
              function(e) {
                for (var t = e.getVideoTracks(), n = 0; n < t.length; n++) {
                  var i = t[n];
          ...
          MediaStreamTrack.getSources(function(n) {
            ...
            e._log("".concat(i.length, " results found")), t(i)
          })
        } else e._log("unable to query supported devices."), n("unable to query supported devices.")
      })
    }
  }, {
    key: "_getTimeoutFps",
